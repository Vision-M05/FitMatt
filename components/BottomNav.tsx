                ...
                {tabs.map(tab => {
                    ...
                    return (
                        <button
                            ...
                            className={`flex flex-col items-center gap-1 px-4 py-2 rounded-2xl transition-all duration-300 ${isActive
                        ...
                        >
                            <div className="relative">
                                <Icon size={22} className={isActive ? 'animate-bounce-in' : ''} />
